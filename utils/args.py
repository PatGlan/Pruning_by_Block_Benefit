...
def get_args_parser():
    ...
    parser.add_argument('--model-resize-by-checkpoint', action='store_true', help="set, if pruned model is loaded")
    ...
    parser.add_argument('--lr-soft-head', type=float, default=5e-4, metavar='LR',
                        help='lower lr bound for cyclic schedulers that hit 0 (1e-5)')

    parser.add_argument('--decay-epochs', type=float, default=30, metavar='N',
                        help='epoch interval to decay LR (for StepLRScheduler)')
    ...
    #parser.add_argument('--distill-method', type=str, default='none', choices=['deit', "none"])
    parser.add_argument('--teacher-model', default='regnety_160', type=str, metavar='MODEL',
                        help='Name of teacher model to train (default: "regnety_160"')
    parser.add_argument('--teacher-model-pretrained', action='store_true')
    parser.add_argument('--teacher-path', type=str, default='')
    parser.add_argument('--distillation-type', default='none', choices=['none', 'soft', 'hard'], type=str, help="")
    parser.add_argument('--distillation-alpha', default=0.5, type=float, help="")
    parser.add_argument('--distillation-tau', default=1.0, type=float, help="")

    parser.add_argument('--disable-kd-loss-use-cls-token', action='store_true')
    parser.add_argument('--kd-loss-alpha', default=1.0, type=float, help="leverage for basis-loss")
    parser.add_argument('--kd-loss-beta', default=0.1, type=float,
                        help="leverage for kd_loss to imitate the featuremap between student and teacher")

    #pruning parameters
    parser.add_argument('--prune-ratio', default=None, type=float, help="ratio of parameters to be pruned, 'None' disables pruning")
    parser.add_argument('--prune-rate-by-block-param-only', action='store_true', help="if activate heads and preprocessing layers are not considerted for the pruning rate")

    parser.add_argument('--prune-start-epoch', default=5, type=int, help="end step Warm Up")
    parser.add_argument('--prune-sparse-epoch', default=25, type=int, help="end step Sparsify")
    ...
    parser.add_argument('--pr-tau-min', default=0.0, type=float, help="sharpening factor at the end of step sparpening. '0'= hard mask")
    ...
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR10', 'CIFAR100', 'IMNET', 'INAT18', 'INAT19', 'IFOOD'],
